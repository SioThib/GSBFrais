		...
		<div id="page">
			...
			<div id="menuGauche">
				...
				<ul id="menuList">
					...
					<li class="smenu">
						<br /><?php echo anchor('c_comptable/', 'Accueil', 'title="Page d\'accueil"'); ?>
					</li>
					<li class="smenu">
						<?php echo anchor('c_comptable/mesFiches', 'Les fiches de frais', 'title="Consultation de des fiches de frais"'); ?>
					</li>
